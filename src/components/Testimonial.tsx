...
// Define interfaces for the testimonial data structure
...
export default function Testimonial() {
  // Type assertion for data to ensure TypeScript knows its structure
  ...
  return (
    <section className="testimonial--section" id="testimonial">
      ...
      <div className="portfolio--section--container">
        {typedData?.testimonial?.map((item: TestimonialItem, index: number) => (
          <div key={index} className="testimonial--section--card">
            <div className="testimonial--section--card--review">
              {Array.from({ length: 5 }, (_reviews, starIndex: number) => (
                <svg
                  key={starIndex}
